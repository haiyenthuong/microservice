package com.payment.infrastructure.helper;
...
public class SecurityHelper {
    ...
    public String getCurrentUserId() {
        try {
            ...
            if (principal instanceof com.payment.infrastructure.config.CustomUserDetails) {
                return ((com.payment.infrastructure.config.CustomUserDetails) principal).getUserId();
            }
